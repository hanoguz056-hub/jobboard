        ...
        "/api/v1/auth/register": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Неверный формат запроса или валидации",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/api/v1/jobs": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Тип: full/part/remote",
                        "name": "type",
                        "in": "query"
                    },
                    {
                        "type": "number",
                        "description": "Мин зарплата",
                        "name": "salary_min",
                        "in": "query"
                    },
                    {
                        "type": "number",
                        "description": "Макс зарплата",
                        "name": "salary_max",
                        "in": "query"
                    }
                ],
